window.addEventListener("load", function () {
  ...
  botonComprar.addEventListener("click", function () {
    ...
    if (productosEnCarrito.length === 0) {
      ...
      // Redirecciona al usuario a index.php si no hay productos en el carrito
    ...
    window.location.href = "index.php"; // Esto también asegura la redirección después de la compra
  });
  ...
  if (window.location.pathname === "/compra.php") {
...
function agregarAlCarritoVisual(producto) {
  if (window.location.pathname !== "/carrito.php") {
